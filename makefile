...
help :
	...
	@echo "Para cada chamada, utilize -apply para aplicar o código, por exemplo: c-vpc-apply."
	...
	@echo "Para cada chamada, utilize -apply para aplicar o código, por exemplo: vpc-apply."
